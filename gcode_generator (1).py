...
class ImageToGcodeApp:
    ...
    def _interpolate_linear_path(self, start_x, start_y, end_x, end_y, num_points=10):
        """Tạo các điểm trung gian dọc theo đường thẳng"""
        points = []
    ...
    def _run_gcode_generation(self):
        ...
        try:
            ...
            gcode.append(f"F{drawing_speed}")  # Thiết lập tốc độ
